...
export default function Travel(this: any) {
    ...
    const cookieIncrement = () => {
        ...
        cookieCounter === 50 && setShowCookie(false)
        cookieCounter === 50 && playSong(Krampus)
    }
    ...
    const story = [
        ...
        <><div onClick={startCookie}><Story story={`Fifty times?`}/></div></>,
        ...
        <Title title='> Elfward.' />,
        <Story story={`You might actually endorse Will in the next head elf election.`} />,
        <Story story={`This has been so stressful. And during the Christmas season, no less!`} />,
        <Story story={`You were happier when you were making toys.`} />,
        <Story story={`Nevertheless, you're pleased everything turned out okay.`} />,
        <Story story={`Charles only destroyed a few presents.`} />,
        <Story story={`You quickly set the elves to work on making replacements.`} />,

        <Title title='> La Befellena.' />,
        <Story story={`Wow, this has been so exciting!`} />,
        <Story story={`You're welcomed into the North Pole with open arms.`} />,
        <Story story={`Santa offers to let you make the rounds with her this Christmas Eve as a thanks for your help.`} />,
        <Story story={`You couldn't be more delighted to accept!`} />,

        <Title title='> Santa Lizzy.' />,
        <Story story={`Wow...what an ordeal.`} />,
        <Story story={`You're grateful to everyone who helped rescue you.`} />,
        <Story story={`The next day, you enter your sleigh, piled high with gifts.`} />,
        <Story story={`The elves cheer as you and La Befellena rise into the air.`} />,
        <Story story={`"On Dasher, on Dancer!" you shout.`} />,
        <Story story={`"On Prancer and Vixen!" La Befellena shouts.`} />,
        <><div onClick={() => setShowEnding(true)}><Story story={`And the elves heard you both exclaim, as you drove out of sight...`} /></div></>,
    ];
        ...
        <div className="App" style={{ backgroundColor: bgColor }}>
            <div className="App-header">
                ...
                {showCombination && <div className="combination">
                    <Combination setShowElement={setShowCombination} id={9} />
                </div>}
